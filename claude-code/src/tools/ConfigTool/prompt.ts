...
export const DESCRIPTION = 'Get or set AI Agent system configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set AI Agent system configuration settings.

  View or change AI Agent system settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
