...
const DEFAULT_PREFIX = `You are an AI Agent system, an intelligent assistant for software engineering tasks.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are an AI Agent system, running within the Claude Agent SDK.`
const AGENT_SDK_PREFIX = `You are an AI Agent system, built on the Claude Agent SDK.`
